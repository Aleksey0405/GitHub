 ...
 * открыть `https://github.com`. Залогиниться. Нажать кнопку `New`.
 * в  `Repository name` ввести TXT, выбрать `Public` и `Add README file`.
 * нажать `Create repository`.
 ...
 * `insert`
 ```txt
 + full_name: Borsuk Aleksey Victorovich
 + age:24,
 + pets: 1 cat Caesar
 + desired_Salary: 1000$
  ```
...
Favourite series - The killing
Favourite food - Draniki
Favourite season - Spring
Desired country - Turkey
 ```
* `Esc`
* `:wq`
 ...
 * Зайти в нужный файл на `https://github.com`
 * Нажать `Edit`
 * Написать пример баг-репорта в формате `TXT`
 14. Сделать Commit changes (сохранить) изменения на веб интерфейсе.
 * Пролистать ниже и нажать `Commit changes`
